...
const Dashboard = () => {
  ...
  return (
    <div className="p-8 text-center bg-[#119DA4]">
      <h1 className="text-[#1F2041] md:text-5xl sm:text-4xl text-3xl font-bold md:py-6">
        ACE YOUR INTERVIEWS
      </h1>
      <p className="text-[#292F36] md:text-2xl sm:text-xl text-lg font-bold ">
        Practice your technical interview and get valuable feedback immediatly!
      </p>
